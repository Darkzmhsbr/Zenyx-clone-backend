import os
from sqlalchemy import create_engine, Column, Integer, String, Float, DateTime, Boolean, Text, ForeignKey, JSON, UniqueConstraint, text
...
# ADICIONAR ao final da classe RemarketingCampaign (se não existir):
